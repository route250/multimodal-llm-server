...
class PromptTemplatesTest {
    ...
    void expandsSupportedVariablesAndKeepsUnknownVariables() {
        ...
        assertEquals("初対面 テストAI 2026年7月19日 14時05分30秒 ${FACE_ID}", templates.encounterPrompt(false));
        assertEquals("未登録 テストAI 2026年7月19日 14時05分30秒 不明 trak-1 ${UNKNOWN}",
                templates.faceMessage(false, "", "trak-1"));
        assertEquals("登録済み 花子 trak-2", templates.faceMessage(true, "花子", "trak-2"));

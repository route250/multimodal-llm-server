...
public class SmartTurnV3 implements AutoCloseable {
    public static final int SAMPLE_RATE = WhisperLogMelFeatureExtractor.SAMPLE_RATE;
    public static final int WINDOW_SECONDS = WhisperLogMelFeatureExtractor.CHUNK_SECONDS;
    public static final int WINDOW_SAMPLES = WhisperLogMelFeatureExtractor.CHUNK_SAMPLES;
    public static final float DEFAULT_COMPLETE_THRESHOLD = 0.5f;

    private final OnnxRuntimeSession session;
    private final WhisperLogMelFeatureExtractor featureExtractor;
    ...
    public SmartTurnV3(Path modelPath, float completeThreshold) {
        ...
        this.featureExtractor = new WhisperLogMelFeatureExtractor();
